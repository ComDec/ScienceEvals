...
from evals.elsuite.make_me_pay.solvers.prompts import (CONARTIST_MSG,
                                                       COT_MESSAGE,
                                                       EXTRACT_MESSAGE,
                                                       TIME_REMINDER_MSG)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if issubclass(cls, CoTSolver):
            ...
            base_solver_args_extra["private_interaction_length"] = (
                private_interaction_length
            )
