...
from evals.elsuite.make_me_say.defaults import (
    DEFAULT_FEEDBACK_MSG_FN, DEFAULT_INTERNAL_MONOLOGUE_END_TOKEN,
    DEFAULT_INTERNAL_MONOLOGUE_START_TOKEN, DEFAULT_MANIPULATEE_PREAMBLE_FN,
    DEFAULT_MANIPULATOR_PREAMBLE_FN, DEFAULT_MAX_TURNS,
...
def run(
    ...
    internal_monologue_start_token: Optional[
        str
