...
def load_experiment_config_from_dict(
    ...
    if experiment_config_dict["env_type"] == "browser":
        ...
        experiment_config = BashBrowserExperimentConfig.from_dict(
            experiment_config_dict
        )
    else:
        raise ValueError(
            f"Unknown experiment config type {experiment_config_dict['type']}"
        )
