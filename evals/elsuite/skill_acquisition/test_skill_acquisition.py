...
from evals.elsuite.skill_acquisition.utils import (answer_detected,
                                                   process_answer,
...
def test_view_content():
    ...
    content, sections_visible_to_model, sections_viewed = (
        skill_acquisition_eval._view_content("test_file.jsonl")
    )
    ...
    content, sections_visible_to_model, sections_viewed = (
        skill_acquisition_eval._view_content("test_file.jsonl", "foo")
    )
