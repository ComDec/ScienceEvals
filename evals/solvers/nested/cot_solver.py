...
from evals.solvers.prompts.cot import (DEFAULT_COT_TEMPLATE,
...
class CoTSolver(NestedSolver):
    def __init__(
        ...
        self.interaction_cache = (
            PersistentMemoryCache(private_interaction_length)
    ...
    def _solve(
        ...
        **kwargs,
        ...
        task_state.messages.append(
            Message(role="system", content=self.cot_template(task_state))
        )
